...
<div class="overlay" id="Eventioverlay2">
  ...
  <div class="overlayContent-event" id="overlayContent2">
    <div class="card form-group">
      ...
      <!-- ########################################## -->
      <div class="row" id="repeatDiv" >
        <!-- Div da mostrare/nascondere -->
        <label class="col-md-2" for="event-repeat-end">Fine riferimento:</label>
        <div class="col-md-2">
          <input class="form-control" type="date" id="event-repeat-end" name="event-repeat-end">
          <div class="invalid-feedback">
            Selezione Invalida
          </div>
        </div>
        <div class="col">
          <select class="form-select" style="margin:auto" id="cadenzaRipetizione" name="cadenzaRipetizione">
